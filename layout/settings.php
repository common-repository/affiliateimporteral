...
$current_module = (isset($_REQUEST['module']) && $_REQUEST['module']) ? sanitize_text_field($_REQUEST['module']) : 'aliexpress';
    ...
    <h2 class="nav-tab-wrapper">
        ...
        foreach ($api_list as $api) { ?>
            <a href="#" class="nav-tab<?php echo $current_module === $api->getType() ? ' nav-tab-active' : ''; ?>"
               rel="<?php echo $api->getType(); ?>"><?php echo $api->getConfigValues('dashboard_title'); ?> settings</a>
        <?php }; // endforeach ?>

      <a href="#" class="nav-tab<?php echo $current_module === 'common' ? ' nav-tab-active' : ''; ?>" rel="common">General settings</a>
      <a href="#" class="nav-tab<?php echo $current_module === 'price_formula' ? ' nav-tab-active' : ''; ?>" rel="price_formula">Price Rules</a>
      <a href="#" class="nav-tab nav-tab-active" rel="shedule_settings">Auto update</a>
            ...
            <tr valign="top">
              ...
              <td class="forminp forminp-text">
                  <div class="fromtoWrapper">
                    <div>
                        from: <input type="text" style="width:150px" id="aeidn_min_product_quantity"
                           name="aeidn_min_product_quantity"
                           value="<?php echo get_option('aeidn_min_product_quantity', 5); ?>"/>
                    </div>
                    <div>
                    to: <input type="text" style="width:150px" id="aeidn_max_product_quantity"
...
function aliexpress_sync_categories() {
  jQuery.get("./admin.php", {
    "page": "aeidn-settings",
    "action": "aliexpress_sync_categories"
  });
}
</script>
