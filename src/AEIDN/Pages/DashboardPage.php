...
if (!class_exists('AEIDN_DashboardPage')) {
    ...
    class AEIDN_DashboardPage extends WP_List_Table
    {
            ...
            switch ($column_name) {
                ...
                case 'info':
                    ...
                    $result_data = AEIDN_DashboardPage::putField($item, "title", true, "edit", "Title", "") .
                        ...
                        AEIDN_DashboardPage::putDescriptionEdit() .
        ...
        public function prepare_items()
        {
            ...
            if ($this->loader) {
                ...
                if (!$this->loader->hasAccount()) {
                    add_settings_error('aeidn_dashboard_error', esc_attr('settings_updated'), 'Please, set up your AliExpress account. <a href="?page=aeidn-settings">Press here</a>.', 'error');
        ...
        static public function putDescriptionEdit()
        {
