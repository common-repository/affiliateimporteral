...
if (!defined('AEIDN_NAME')) {
  define('AEIDN_NAME', 'Affiliate Al');
}
...
if (!function_exists('aeidn_get_update')) {

    /**
     * @param $type
     * @return AEIDN_AbstractLoader
     */
    function aeidn_get_update()
    {
        echo '<div class="getUpdatee">Please, get the PRO version of plugin to get this featuure. <a href="https://cr1000team.com/shop/" target="_blasnk">Click here to upgrade.</a></div>';
    }
