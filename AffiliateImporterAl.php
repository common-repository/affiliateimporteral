<?php
/*
  Plugin Name: AffiliateImporterAI
...
if (!class_exists('Dnolbon')) {
  ...
  class Dnolbon
  {
    ...
    public function woocomerceCheckError()
    {
      ...
      $message = __(
        'Please install the Woocommerce plugin first.',
        'sample-text-domain'
      );
    ...
    public function registerAssets()
    {
      ...
      wp_enqueue_style('aeidn-ui-css','https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.0/themes/base/jquery-ui.css',false,"1.9.0",false);
